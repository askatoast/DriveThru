...
import 'package:rider_version/Assistant/assistantMethods.dart';
import 'package:rider_version/Assistant/geoFireAssistant.dart';
...
import 'package:rider_version/screens/history_screen.dart';
import 'package:rider_version/screens/login_screen.dart';
import 'package:rider_version/screens/profile_screen.dart';
import 'package:rider_version/screens/rating_screen.dart';
import 'package:rider_version/screens/search_screen.dart';
import 'package:rider_version/screens/sign_up.dart';
import 'package:rider_version/widgets/collectFare_dialog.dart';
import 'package:rider_version/widgets/divider.dart';
import 'package:rider_version/widgets/noDriverAvailable_Dialog.dart';
...
class _MainScreenState extends State<MainScreen> with TickerProviderStateMixin {
  ...
  void saveRiderRequest() {
    ...
    rideStreamSubscription = rideRequestRef.onValue.listen((event) async {
      ...
      if (statusRide == "accepted") {
        displayDiriverDetailsContainer();
  ...
  void displayDiriverDetailsContainer() {
    setState(() {
      requestRideContainerHeight = 0.0;
      rideDetailsContainerHeight = 0;
      bottomPaddingMap = 290.0;
...
//-------------ride fare estimate panel
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(
                                  ((tripDirectionDetails != null)
                                      ? '\$${(AssistantMethods.calculateFare(tripDirectionDetails)) / 2}'
                                      : ''),
                                  style: TextStyle(
                                    fontFamily: "Brand Bold",
                                  ),
                      ...
                      GestureDetector(
                        onTap: () {
                          displayToastMessage("searching Standard...", context);

                          setState(() {
                            state = "requesting";
                            carRideType = "standard";
                          });
                          displayRequestContainer();
                          availableDrivers =
                              GeoFireAssistant.nearbyAvailableDriversList;
                      ...
                      GestureDetector(
                        onTap: () {
                          displayToastMessage("searching Pro...", context);
          ...
          //Ride request and Cancel request feature
          Positioned(
            bottom: 0.0,
            left: 0.0,
            right: 0.0,
                        ...
                        child: DefaultTextStyle(
                          ...
                          child: AnimatedTextKit(
                            animatedTexts: [
                              ...
                              FadeAnimatedText('Finding Driver..'),
                            ],
...
//display assigned driver info
      ...
      if (map != null) {
        ...
        switch (callBack) {
          ...
          case Geofire.onKeyMoved:
            ...
            nearbyAvailableDrivers.latitude = map['latitude'];
            nearbyAvailableDrivers.longitude = map['longitude'];
            GeoFireAssistant.updatedDriverNearbyLocation(
                nearbyAvailableDrivers);
            updateAvailableDriversOnMap();
            break;
  ...
  void searchNearestDriver() {
    ...
    //since the nearest available drivers list is already sorted
    ...
    driversRef
      ...
      if (await snap.value != null) {
        ...
        if (carType == carRideType) {
          ...
          displayToastMessage(carRideType + "Not available now.", context);
        }
      } else {
        displayToastMessage("No car found.", context);
      }
    });
